...
export const providerEndpoints: ChainProvider[] = [
  {
    ...
    endpoints: [
      ...
      { name: 'Light Client', endpoint: 'light://substrate-connect/polkadot/astar' },
    ],
  ...
  },
  {
    ...
    endpoints: [
      ...
      { name: 'Light Client', endpoint: 'light://substrate-connect/kusama/shiden' },
    ],
  ...
  },
  {
    ...
    endpoints: [
      ...
      { name: 'Light Client', endpoint: 'light://substrate-connect/tokyo/shibuya' },
    ],
