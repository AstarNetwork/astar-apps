  ...
  <div class="tw-relative">
    ...
    <button type="button" @click="openOption = !openOption" class="option-button">
      <div class="tw-flex tw-items-center tw-justify-between">
        <div class="tw-flex tw-items-center">
          <div class="tw-flex">
            <div
              class="tw-font-semibold tw-text-blue-400"
            >{{ constructors[constructorIndex].identifier }}</div>
          ...
          <div class="tw-flex tw-items-center tw-justify-between">
            <div class="tw-flex tw-items-center">
              <div class="tw-flex dark:tw-text-white tw-px-4 tw-py-2">
                <div class="tw-font-semibold tw-text-blue-400">{{ constructor.identifier }}</div>
    ...
    <div class="tw-mt-7 tw-ml-6">
      <div
        ...
        :key="paramIndex"
      >
        <div class="tw-ml-5 tw-pl-10 tw-my-3" v-if="constructors[constructorIndex].args.length">
