      ...
      >
        <div>
          <div>
            ...
            >{{ $t('dapps.addExistingCodeHash') }}</h3>
            ...
            <div class="tw-grid tw-grid-cols-1 tw-gap-6">
              ...
              <div>
                ...
                <input-file @dropFile="onDropFile" :file="wasmFromFile" :extension="extensionFile" />
              </div>
        ...
        <div class="tw-mt-6 tw-flex tw-justify-center tw-flex-row-reverse">
          <button type="button" @click="save" class="save-button">{{ $t('dapps.modals.save') }}</button>
