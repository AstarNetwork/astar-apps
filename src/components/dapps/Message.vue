<template>
  ...
  >
    <div class="tw-tooltip tw-relative">
      ...
      <!-- Tooltip -->
      <span
        class="tw-tooltip-shadow dark:tw-bg-darkGray-900 tw-hidden tw-absolute tw-z-10 tw-top-6 tw-left-5 tw-text-s dark:tw-text-white tw-bg-gray-800 tw-rounded-md"
      >
        <div>
          <div
          ...
          >
            <div
              class="tw-font-semibold"
              :class="[
                message.isConstructor ? 'tw-text-blue-400' : 'tw-text-yellow-400',
              ]"
            >
              {{ message.identifier }}
            </div>
          ...
          <div
            class="tw-leading-7 tw-px-2 tw-py-2 tw-float-left tw-w-96 tw-bg-gray-200 dark:tw-bg-darkGray-900"
          >
            {{ docsString }}
          </div>
        </div>
