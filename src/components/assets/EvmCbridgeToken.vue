      ...
      <q-slide-transition :duration="150">
        <div v-show="isExpand || width >= screenSize.sm" class="row__right">
          <div>
            ...
            <span class="text--expand-menu">Send</span>
            <q-tooltip>
          ...
          <div>
            ...
            <span class="text--expand-menu">Wallet</span>
            <q-tooltip>
          ...
          <div>
            ...
            <span class="text--expand-menu">Favorite</span>
            <q-tooltip>
              <span class="text--tooltip">Add to favorite</span>
            </q-tooltip>
          </div>
        </div>
      </q-slide-transition>
