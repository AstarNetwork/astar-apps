<template>
  <astar-simple-modal
    v-if="isModalHrmpBridge"
    :show="isModalHrmpBridge"
    :title="$t('assets.xcm')"
...
import { ChainAsset, useXcmEvm, useAccount, useTooltip, useHrmpBridge } from 'src/hooks';
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const closeModal = async (): Promise<void> => {
      ...
      props.handleModalHrmpBridge({ isOpen: false, currency: null });
