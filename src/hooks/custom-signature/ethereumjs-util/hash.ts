...
const keccak224 = createHashFunction(() => createKeccakHash('keccak224'));

const k256 = createHashFunction(() => createKeccakHash('keccak256'));

const keccak384 = createHashFunction(() => createKeccakHash('keccak384'));

const keccak512 = createHashFunction(() => createKeccakHash('keccak512'));
