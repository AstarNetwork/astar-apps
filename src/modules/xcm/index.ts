...
export let xcmChainObj: XcmChainObj = {
  ...
  [Chain.ASTAR]: {
    ...
    endpoints: ['wss://rpc.astar.network'],
  ...
  [Chain.SHIDEN]: {
    ...
    endpoints: ['wss://rpc.shiden.astar.network'],
  ...
  [Chain.KARURA]: {
    ...
    endpoints: ['wss://karura-rpc-0.aca-api.network'],
  ...
  [Chain.ACALA]: {
    ...
    endpoints: ['wss://acala-rpc-0.aca-api.network'],
  ...
  [Chain.KINTSUGI]: {
    ...
    endpoints: ['wss://api-kusama.interlay.io/parachain'],
  ...
  [Chain.INTERLAY]: {
    ...
    endpoints: ['wss://api.interlay.io/parachain'],
  ...
  [Chain.CRUST_SHADOW]: {
    ...
    endpoints: ['wss://rpc2-shadow.crust.network'],
  ...
  [Chain.KHALA]: {
    ...
    endpoints: ['wss://khala-api.phala.network/ws'],
  ...
  [Chain.BIFROST_KUSAMA]: {
    ...
    endpoints: ['wss://bifrost-rpc.liebi.com/ws'],
  ...
  [Chain.EQUILIBRIUM]: {
    ...
    endpoints: ['wss://node.pol.equilibrium.io/'],
  ...
  [Chain.UNIQUE]: {
    ...
    endpoints: ['wss://ws.unique.network'],
